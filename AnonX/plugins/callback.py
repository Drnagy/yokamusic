...
async def unban_assistant_(_, CallbackQuery):
    ...
    if not a.can_restrict_members:
        return await CallbackQuery.answer(
            "» عذرا هناك خطأ ..!/n/n- تاكد من اعطائي صلاحيات الادمن تم حاول مرة اخري .",
            show_alert=True,
        )
    else:
        try:
            ...
            return await CallbackQuery.answer(
                "» لم استطع الغاء حظر الحساب المساعد ...يجب الغاء حظره يدويا!",
                show_alert=True,
            )
        return await CallbackQuery.edit_message_text(
            "» تم الغاء حظر الحساب المساعد بنجاح ✓/n/nـ الان يمكنك تشغيلي بدون مشاكل! "
        )
