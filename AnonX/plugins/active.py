...
async def activevc(_, message: Message):
    mystic = await message.reply_text(
        "جـاري جـلب المحـادثات الصـوتية الحاليـة ..."
    )
    ...
    if not text:
        ...
        await mystic.edit_text(
            f"**حسـنا!  اليك قائمـة المحـادثات الصوتيـه الجـارية :-**\n\n{text}",
...
async def activevi_(_, message: Message):
    mystic = await message.reply_text(
        "جـاري جـلب محـادثات الفـيديو الحـالية..."
    )
    ...
    if not text:
        ...
        await mystic.edit_text(
            f"**حسـنا!  اليڪ قائمـة محـادثات الفيديـو الجـارية :-**\n\n{text}",
            disable_web_page_preview=True,
        )
