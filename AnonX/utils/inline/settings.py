    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="« جـودة الصـوت »", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="« جـودة الفـيديو »", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="« الاستجـابة للاوامـر »", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="« وضـع التنظـيف »", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝐘𝐎𝐊𝐀 | يـوڪــا", url=f"https://t.me/INAGYI",
            ),
        ],
        [
            InlineKeyboardButton(
